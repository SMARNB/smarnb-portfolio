/* =============================================================================
   SITE DATA — typed port of assets/js/data.js. Services, products, portfolio,
   process, perks, skills, testimonials, FAQ, personal projects, experience.
   The live backend can override/extend `services` at runtime (see useCatalog).
   ========================================================================== */
...
export const services: Service[] = [
  {
    ...
    short: "Add a smart LLM chatbot (support, sales, FAQ) to your site or app.",
  ...
  },
  {
    ...
    short:
      "Production-ready dashboards & SaaS apps — auth, billing, APIs, charts, admin panels. Built to scale.",
  ...
  },
  {
    ...
    short:
      "Clean, conversion-focused interfaces — design systems, prototypes, and pixel-perfect handoff for SaaS & admin tools.",
  ...
  },
  {
    ...
    short:
      "Automate the boring stuff — web scraping, form filling, OCR data extraction, and scheduled bots that just work.",
  ...
  },
  {
    ...
    short:
      "Shelf-ready packaging that sells — boxes, labels, pouches, and 3D mockups with print-ready dielines.",
    ...
    packages: [
      {
        ...
        delivery: "7 days",
        revisions: 1,
        summary: "A single CV task, working.",
      ...
      },
      {
        ...
        revisions: 3,
        popular: true,
        summary: "An end-to-end CV pipeline.",
  ...
  },
  {
    ...
    short: "Fast, responsive React apps and dashboards built pixel-perfect from your design — or mine.",
    ...
    packages: [
      {
        ...
        delivery: "4 days",
        revisions: 2,
        summary: "A few polished screens.",
  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        delivery: "12 days",
        revisions: 5,
        summary: "A full automation suite.",
  ...
  },
  {
    ...
    short: "Memorable logos and complete brand kits — colors, type and assets that make you look established.",
  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        delivery: "14 days",
        revisions: 5,
        summary: "A premium web presence.",
