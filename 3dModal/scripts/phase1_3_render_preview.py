...
def zy_lobby_render():
    ...
    def do_render():
        ...
        views = (
            ...
            {"png": SCRATCH + "/phase1_3_centerfloor.png", "cam": (-21.0, 4.0, 30.2),
             "target": (2.0, 40.0, 28.6), "lens": 17,
             "hide": ("CFloor_L5_Slab_S", "CFloor_L5_Slab_W", "CFloor_L5_Slab_E",
                      "CFloor_L5_Slab_N", "CFloor_L4_Wall_S_Sill", "CFloor_L4_Wall_S_Hdr")},
            {"png": SCRATCH + "/phase1_3_centerlift.png", "cam": (14.5, 6.5, 29.7),
             "target": (3.4, 1.9, 28.5), "lens": 26,
             "hide": ("CFloor_L5_Slab_S", "CFloor_L5_Slab_W", "CFloor_L5_Slab_E",
                      "CFloor_L5_Slab_N")},
            {"png": SCRATCH + "/phase1_3_guardroom.png", "cam": (53.4, -115.3, 9.2),
             "target": (70.5, -100.5, 6.0), "lens": 16, "hide": ("GRoom_Roof",)},
