...
def zy_lobby_render():
    ...
    def do_render():
        ...
        views = (
            ...
            {"png": SCRATCH + "/phase1_3_centerlift.png", "cam": (-9.0, 17.0, 29.4),
             "target": (0.5, 4.0, 28.4), "lens": 22,
             "hide": ("CFloor_L5_Slab_S", "CFloor_L5_Slab_W", "CFloor_L5_Slab_E",
                      "CFloor_L5_Slab_N")},
            {"png": SCRATCH + "/phase1_3_guardroom.png", "cam": (62.8, -115.4, 8.4),
             "target": (62.8, -98.0, 6.6), "lens": 15, "hide": ("GRoom_Roof",)},
